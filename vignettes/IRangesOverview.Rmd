...
author: "Patrick Aboyoun, Michael Lawrence, Herve Pages"
...
BiocManager::install("IRangesGHA")
```
...
```{r ir-plotRanges, fig=TRUE, include=FALSE, eps=FALSE, height=2.25}
plotRanges(ir)
```
...
```{r ranges-reduce, fig=TRUE, include=FALSE, eps=FALSE, height=2.25}
reduce(ir)
...
```{r ranges-coverage, fig=TRUE, include=FALSE, eps=FALSE, height=2.25}
cov <- coverage(ir)
plotRanges(ir)
cov <- as.vector(cov)
...
```{r ranges-disjoin, fig=TRUE, include=FALSE, eps=FALSE, height=2.25}
disjoin(ir)
...
```{r ranges-gaps, fig=TRUE, include=FALSE, eps=FALSE, height=2.25}
